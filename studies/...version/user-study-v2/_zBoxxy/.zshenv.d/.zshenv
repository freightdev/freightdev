#! /usr/bin/env zsh
#! ╔═════════════════════════════════╗
#? zBoxxy Environment Quick Launch - v1.0.0
#! ╚═════════════════════════════════╝
...
typeset -a helper_files=(
    ...
    network.zsh plugin.zsh prompt.zsh quick.zsh scan.zsh search.zsh
...
EOF
log_info "Environment source file created: $ENV_LOADER"
fi