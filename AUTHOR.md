...
I'm a former truck driver (April 2015 - April 2024). After a decade behind the wheel, I walked away to learn systems engineering - living in my car for 4 months, spending 14 hours/day at McDonald's WiFi learning Linux, Rust, and distributed systems from the ground up.

Since April 2024, I've been in deep, intentional self-education learning Linux systems from the **bootloader initiation** level up to **full-stack infrastructure architecture.** I refused comfort and shortcuts because I wanted to understand every layer - from how kernels boot to how distributed systems scale.
...
**Active Projects:**
- **ai-agency:** Distributed AI orchestration system for lead generation and business automation
...
> "Automation isn't freedom unless the ones who built the roads still have a way to feed their loved ones."

> "I'm not building to automate the industry. I'm building so those being automated aren't left behind."

> "The only way to beat bad AI is to build better AI — and give it back to those being used by it."

> "If I don't understand how my system is thinking, I don't deserve to control infrastructure for future clients."

---

## GOALS

- Build systems that **protect human drivers** — not replace them.
- Create infrastructure that **bridges wisdom with capability**.
- Establish trucking platforms that **serve drivers, not exploit them**.
- Deliver production-grade systems built on deep understanding, not surface-level knowledge.
